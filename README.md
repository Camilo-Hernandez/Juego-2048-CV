...
En este repositorio se desarrolló un programa con el fin de aplicar los conceptos dados en las clases de Procesamiento Digital de Imágenes de la Universidad de Antioquia. En dicho programa se implementó un juego matemático que se controla mediante la cámara web de la computadora.
